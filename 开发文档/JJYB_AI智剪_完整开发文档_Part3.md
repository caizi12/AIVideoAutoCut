...
后续新增功能不在完整开发文档中展开设计细节，统一放到 `开发文档/功能设计/` 目录，主文档只保留入口，避免路线图和具体方案混在一起。

- [字幕驱动自动补画面 / 自动 B-roll 素材匹配与合成](功能设计/字幕驱动自动补画面_功能设计.md)
...
- v2.x 专项计划 (2026-05-27): 新增功能设计文档目录，并收录字幕驱动自动补画面设计
